...
export const updatePresets = async (groupIds, presetId) => {
    Object.entries(groupIds).forEach(([id, value]) => {
        try {
            ThingsConfig.findOne({
                ...
                if (!result) {
                    ...
                    const transformProps = buildPropsForPresetUpdate(props, presetId, value);
...
export const updatePresetsBckup = async (group, presetId) => {
